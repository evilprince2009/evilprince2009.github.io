...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _about_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./about-component */ \"./src/about-component.ts\");\n/* harmony import */ var _clear_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./clear-component */ \"./src/clear-component.ts\");\n/* harmony import */ var _contact_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contact-component */ \"./src/contact-component.ts\");\n/* harmony import */ var _exception_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./exception-component */ \"./src/exception-component.ts\");\n/* harmony import */ var _help_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./help-component */ \"./src/help-component.ts\");\n/* harmony import */ var _shell_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shell-component */ \"./src/shell-component.ts\");\n/* harmony import */ var _skills_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./skills-component */ \"./src/skills-component.ts\");\n/* harmony import */ var _sudo_rm_rf_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sudo-rm-rf-component */ \"./src/sudo-rm-rf-component.ts\");\n/* harmony import */ var _logic_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./logic-module */ \"./src/logic-module.ts\");\n/* harmony import */ var _uuid_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./uuid-component */ \"./src/uuid-component.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nvar terminal = document.querySelector(\"#terminal\");\r\nvar container = document.querySelector(\"#insert\");\r\nvar quit = document.querySelector(\"#quit\");\r\nvar footer = document.querySelector(\".footer\");\r\nvar hide = document.querySelector(\"#hide\");\r\nvar mainBody = document.querySelector(\".container\");\r\nvar userIdHolder = document.querySelector(\".session-userid\");\r\nvar maximizeBox = document.querySelector(\".maximize-terminal\");\r\nvar logicModule = new _logic_module__WEBPACK_IMPORTED_MODULE_8__.LogicModule();\r\nvar shell = new _shell_component__WEBPACK_IMPORTED_MODULE_5__.ShellComponent(container);\r\nvar help = new _help_component__WEBPACK_IMPORTED_MODULE_4__.HelpComponent(container);\r\nvar clear = new _clear_component__WEBPACK_IMPORTED_MODULE_1__.ClearComponent(container);\r\nvar exception = new _exception_component__WEBPACK_IMPORTED_MODULE_3__.ExceptionComponent(container);\r\nvar userid = new _uuid_component__WEBPACK_IMPORTED_MODULE_9__.UUIDComponent(userIdHolder);\r\nvar contact = new _contact_component__WEBPACK_IMPORTED_MODULE_2__.ContactComponent(container);\r\nvar about = new _about_component__WEBPACK_IMPORTED_MODULE_0__.AboutComponent(container);\r\nvar skills = new _skills_component__WEBPACK_IMPORTED_MODULE_6__.SkillsComponent(container);\r\nvar destroy = new _sudo_rm_rf_component__WEBPACK_IMPORTED_MODULE_7__.SudoRmRfComponent(terminal);\r\nwindow.addEventListener(\"DOMContentLoaded\", function () {\r\n    maximizeBox.classList.add(\"flip\");\r\n    shell.render();\r\n    userid.render(logicModule.userIdGenerator());\r\n});\r\ncontainer.addEventListener(\"keyup\", function (e) {\r\n    e.preventDefault();\r\n    var eventTarget = e.target;\r\n    if (eventTarget.className === \"command\" && e.key === \"Enter\") {\r\n        eventTarget.disabled = true;\r\n        var input_value = eventTarget.value.toString().toLowerCase();\r\n        if (input_value === \"help\") {\r\n            help.render();\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"about\") {\r\n            about.render();\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"skills\") {\r\n            skills.render();\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"contact\") {\r\n            contact.render();\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"facebook\") {\r\n            logicModule.openSocialProfile(input_value);\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"linkedin\") {\r\n            window.open(\"https://www.linkedin.com/in/evilprince2009\");\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"quora\") {\r\n            window.open(\"https://bn.quora.com/profile/%E0%A6%87%E0%A6%AC%E0%A6%A8%E0%A7%87-%E0%A6%A8%E0%A6%BE%E0%A6%B9%E0%A6%BF%E0%A7%9F%E0%A6%BE%E0%A6%A8-Ibne-Nahian\");\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"github\") {\r\n            logicModule.openSocialProfile(input_value);\r\n            shell.render();\r\n        }\r\n        else if (container !== null && input_value === \"cls\") {\r\n            clear.render();\r\n            shell.render();\r\n        }\r\n        else if (input_value === \"sudo rm -rf\") {\r\n            destroy.render();\r\n        }\r\n        else if (input_value === \"exit\") {\r\n            quitTerminal();\r\n        }\r\n        else if (logicModule.isWhitespace(input_value)) {\r\n            shell.render();\r\n        }\r\n        else {\r\n            exception.render(input_value);\r\n            shell.render();\r\n        }\r\n    }\r\n});\r\nquit.addEventListener(\"click\", function (e) {\r\n    e.preventDefault();\r\n    quitTerminal();\r\n});\r\nvar quitTerminal = function () {\r\n    var _a;\r\n    (_a = terminal.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(terminal);\r\n    footer.classList.add(\"footer-on-exit\", \"vertical-center\");\r\n};\r\nhide.addEventListener(\"click\", function (e) {\r\n    e.preventDefault();\r\n    terminal.classList.add(\"flip\");\r\n    maximizeBox.classList.remove(\"flip\");\r\n});\r\nmaximizeBox.addEventListener(\"click\", function () {\r\n    maximizeBox.classList.add(\"flip\");\r\n    terminal.classList.remove(\"flip\");\r\n    shell.shellFocus();\r\n});\r\nmainBody.addEventListener(\"click\", function (e) {\r\n    var _a;\r\n    var targetButton = e.target;\r\n    if (targetButton.className === \"restore-button\") {\r\n        (_a = targetButton.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(targetButton);\r\n        footer.classList.remove(\"footer-on-exit\", \"vertical-center\");\r\n        location.reload();\r\n    }\r\n});\r\n\n\n//# sourceURL=webpack://ShellFolio/./src/scripts.ts?");
